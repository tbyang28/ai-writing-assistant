...
<template>
  <div class="flex-1 flex items-center justify-center bg-gradient-to-br from-brand-50 via-white to-blue-50">
    <div class="w-full max-w-sm mx-4">
      <!-- Header -->
      <div class="text-center mb-8">
        <h1 class="text-2xl font-bold text-gray-900">AI 写作助手</h1>
        <p class="text-sm text-gray-500 mt-1">让创作更轻松</p>
      </div>
      ...
      <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div v-if="errorMsg" class="text-sm text-red-500 bg-red-50 px-3 py-2 rounded-lg">{{ errorMsg }}</div>
